...
class installationService {
	...
	*/
	...
	async getInstallationsByOrgUUID(orgUUID) {
		if (orgUUID) {
			let selectSQL = `SELECT i.uuid as instUUID, i.address, i.orgUUID, i.state, i.operation, i.moving, iD.deviceUUID from installation i
							INNER JOIN instDevice iD on i.uuid = iD.instUUID
							where orgUUID=?;`
